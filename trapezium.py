'''
This file makes an animation for the derivation of the area of a trapezium
URL: https://www.youtube.com/watch?v=w27rQCRa5yo
Run a manim file like this: manim -pqh trapezium.py TrapeziumArea
'''
