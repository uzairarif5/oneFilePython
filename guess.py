...
print ('type "1" for easy (1-10) (5 seconds)')
print ('type "2" for medium (1-100) (10 seconds)')
print ('type "3" for hard (1-1000) (20 seconds)')
mode = input('>>>')
def check():
	global mode
	global l
...
def num():
	...
	if d2 > t:
		...
		if i > no:
			...
			end1 = time()
			d = round(end1 - start)
			print('\nYou guessed it right, the secret number is ', i)
			sleep(1)
